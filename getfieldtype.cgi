...
t|T|tmp|tmp2m|t2m|t2msst|t2x|t2n|TMP2m|TMAX2m|tasmax|TMIN2m|tasmin|max2t|temp|tmin|tmax|tg|tn|tx|tmx|tmn|p2m_t|tas|temp2|air2m|no2Tsfc|p2t|NT2M|T2M|air_temperature1|tempanomaly|temperature_anomaly|air|TMP_2maboveground) field_type="Temperature";;
