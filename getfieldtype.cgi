...
T|tmp|tmp2m|t2m|t2x|t2n|TMP2m|TMAX2m|tasmax|TMIN2m|tasmin|max2t|temp|tmin|tmax|tg|tn|tx|p2m_t|tas|temp2|air2m|no2Tsfc|p2t|NT2M|air_temperature1|tempanomaly|air|TMP_2maboveground) field_type="Temperature";;
