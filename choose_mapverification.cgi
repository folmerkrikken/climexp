...
cat <<EOF
<input type="radio" name="verif" value="mapbrier" $checked_mapbrier>Brier score
(<input type="radio" name="verif" value="mapbriar" $checked_mapbriar>alternative)<br>
...
<input type="radio" name="verif" value="maproc" $checked_maproc>Area under the ROC curve,
