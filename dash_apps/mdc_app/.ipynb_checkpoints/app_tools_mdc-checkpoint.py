...
def create_cor_fires(clickData,base_time,valid_time,area_size,variable='MDC (from TP)'):
    ...
    if REGION:
        ...
        pred1d = pred.kprep.mean(dim=['lat','lon']).sel(quantile=0.5)
        ...
        pred1d = pred.kprep.sel(quantile=0.5)
        obs1d = pred.obs
