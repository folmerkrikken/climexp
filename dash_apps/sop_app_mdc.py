...
page_1_layout = html.Div(children=[
    html.H1(children='KPREP empirical forecasting system - Monthly Drought Code / Fire weather risk'),
    ...
    html.Div([
        ...
        style={'width':'80vh','display': 'inline-block','margin': {'b': 50, 'r': 10, 'l': 30, 't': 10}}),    
    #html.Div([
    #    dcc.Graph(id='mdc_predictand_plot2')],
    #    style={'width':'80vh','display': 'inline-block','margin': {'b': 50, 'r': 10, 'l': 30, 't': 10},'horizontal-align':'middle'}),
    #html.Div([
    #    dcc.Graph(id='predictand_plot2')],
    #    style={'width':'80vh','display': 'inline-block','margin': {'b': 50, 'r': 10, 'l': 30, 't': 10},'horizontal-align':'middle'}),
    #html.Div([
    #    dcc.Graph(id='predictor_plot2')],
