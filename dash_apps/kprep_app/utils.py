    ...
    header = html.Div(
                ...
                html.Div(
                    ...
                    html.Div(
                        ...
                        html.Div(
                            [
                            html.Div(children='This application can be used to explore the seasonal forecasts of the KPREP empirical forecasting system. The seasonal forecasts is based on a statistical emprical forecasting model, which uses past observations to deduce relations between the weather in the last three months (up to the beginning of the month) and the weather over the next months (from the end of the month). The main predictors are large scale climate indices (such as e.g. El Nino) and the trends due to global warming. Overfitting is avoided as much as possible. The system has been documented in Eden et al. 2015 '),#,style=style_box),
                            html.Br(),
