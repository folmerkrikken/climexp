...
<a href=\"${base}_yr.txt\">raw data</a>). <a href=\"plot_annualcycle.cgi?base=$base&computed=$computed&station=$station&name=$name&period=$period&VAR=$VAR&plotunits=$plotunits&id=$EMAIL\">Plot one annual cycle</a></div>"
