...
. ./init.cgi
. ./getargs.cgi
export CONFIG_DIR=/home/oldenbor/climexp/htdig/
...
PATH=/usr/lib/cgi-bin/:/usr/bin:$PATH
htsearch -c $CONFIG_DIR/htdig.conf <<EOF | sed -e "s/FORM_EMAIL/$EMAIL/g" -e "s/%40/@/g" -e "s/bhlclimtmp/climexp/g" -e "s/bhlclim/climexp/g"
$FORM_words
