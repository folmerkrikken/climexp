...
{plottitle}. {ensembletext}(<a href='{pngImg}'>png</a>, <a href='{epsImg}'>eps</a>, <a href='{pdfImg}'>pdf</a>, <a href='{plotfile}'>plotscript</a>, <a href='plotfile2zip.cgi?plotfile={plotfile}'>raw data</a>)
<center><img src='{pngImg}' alt='' width=405 /></center>'
</div>
</td></tr></table>
""".format(plottitle=plottitle, ensembletext=ensembletext, pngImg=pngfile, epsImg=epsfile, pdfImg=epsfile.rstrip('.eps')+'.pdf', plotfile=plotfile))
