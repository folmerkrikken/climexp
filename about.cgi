...
<p>The KNMI Climate Exoplorer is not operational: if it breaks down it will be fixed during Dutch office hours. Over the last few years the availability has been pretty good, although sometimes a few users slow down the system by doing large computations simultaneously. The <a href="forecast_verification.cgi?id=$EMAIL">seasonal forecast verification</a> page was supported by the EU project <a href="http://ensembles-eu.metoffice.com/" target="_new">ENSEMBLES</a>, the rest is an informal KNMI project.

<p>The support team consists of <a href="http://www.knmi.nl/over-het-knmi/onze-mensen/geert-jan-van-oldenborgh">one research scientist</a>, next to my day job writing <a href="https://scholar.google.nl/citations?hl=nl&user=q9wj1loAAAAJ&view_op=list_works&sortby=pubdate">research papers</a>, in practice I spent about a day per week on the Climate Explorer and related <a href="http://www.knmi.nl/klimatologie/monthly_overview_world_weather/">projects</a>.
