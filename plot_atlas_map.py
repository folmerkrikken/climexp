...
class PlotAtlasMap:
    ...
    def __init__(self, params, logLevel=logging.DEBUG):
    ...
    def process(self):
        ...
        print "<font color=#ff2222>plot_atlas_map: UNDER CONSTRUCTION</font>"
        print "Hatching of regions where the change is small compared to natural variability is not yet ready<br>"

        ## First find files
        files = get_file_list(self.params)
