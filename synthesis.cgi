...
case "$FORM_factortype" in
    ...
    auto) auto_checked="checked";;
    *) none2_checked="checked";;
esac
...
<tr><td>Inflate:<td>
<input type="radio" class="formradio" name="factortype" value="none" $none2_checked>only natural variability, no inflation necessay,<br>
...
set yrange [(STATS_min/10):(SSTATS_max*1.1)]
$setlogscaley
