...
<tr><td>&nbsp;<td><div class="kalelink"><a href="getindices.cgi?WMO=CDIACData/ch4_monthly&STATION=CH4&TYPE=i&id=$EMAIL">Global marine CH<sub>4</sub> concentrations</a> (1983-now, NOAA), <a href="getindices.cgi?WMO=CDIACData/ch4_annual&STATION=CO2&TYPE=i&id=$EMAIL&NPERYEAR=1">annual mean 0001-now</a></div>
<td><a href="http://www.esrl.noaa.gov/gmd/ccgg/trends/index.html#global" target="_new"><img src="images/info-i.gif" alt="more information" border="0"></a>
