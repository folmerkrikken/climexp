...
elif bd =='/home/oldenbor/climexp/kprep/': # We're on climate explorer
...
for p,predictand in enumerate(predictands):
    ...
    if predictand == 'GISTEMP':
        ...
        gcecom_anom = gcecom.groupby('time.month') - gcecom.sel(time=slice('1980','2010')).groupby('time.month').mean('time')
