...
<tr>
<td><div class="kalelink"><a href="getindices.cgi?WMO=KNMIData/rr_max&STATION=rr_max&TYPE=p&id=$EMAIL&NPERYEAR=366">Maximum precipitation on one of the approx. ~300 dutch 8-8 stations</a>, <a href="getindices.cgi?WMO=KNMIData/rr_num&STATION=rr_num&TYPE=i&id=$EMAIL&NPERYEAR=366"">number of stations</a> (1906-now, KNMI)<br>
Uncorrected.</div>
<td><a href="http://www.knmi.nl/klimatologie/daggegevens/nsl-download.cgi?language=eng" target="_new"><img src="images/info-i.gif" alt="more information" border="0"></a>
<tr>
