...
country_values = [['Afghanistan', 'Afghanistan'],
               ...
               ['US_Alabama', 'US Alabama'],
               ['US_Alaska', 'US Alaska'],
               ['US_Arizona', 'US Arizona'],
               ['US_Arkansas', 'US Arkansas'],
               ['US_California', 'US California'],
               ['US_Colorado', 'US Colorado'],
               ['US_Connecticut', 'US Connecticut'],
               ['US_Delaware', 'US Delaware'],
               ['US_Florida', 'US Florida'],
               ['US_Georgia', 'US Georgia'],
               ['US_Hawaii', 'US Hawaii'],
               ['US_Idaho', 'US Idaho'],
               ['US_Illinois', 'US Illinois'],
               ['US_Indiana', 'US Indiana'],
               ['US_Iowa', 'US Iowa'],
               ['US_Kansas', 'US Kansas'],
               ['US_Kentucky', 'US Kentucky'],
               ['US_Louisiana', 'US Louisiana'],
               ['US_Maine', 'US Maine'],
               ['US_Maryland', 'US Maryland'],
               ['US_Massachusetts', 'US Massachusetts'],
               ['US_Michigan', 'US Michigan'],
               ['US_Minnesota', 'US Minnesota'],
               ['US_Mississippi', 'US Mississippi'],
               ['US_Missouri', 'US Missouri'],
               ['US_Montana', 'US Montana'],
               ['US_Nebraska', 'US Nebraska'],
               ['US_Nevada', 'US Nevada'],
               ['US_New_Hampshire', 'US New Hampshire'],
               ['US_New_Jersey', 'US New Jersey'],
               ['US_New_Mexico', 'US New Mexico'],
               ['US_New_York', 'US New York'],
               ['US_North_Carolina', 'US North Carolina'],
               ['US_North_Dakota', 'US North Dakota'],
               ['US_Ohio', 'US Ohio'],
               ['US_Oklahoma', 'US Oklahoma'],
               ['US_Oregon', 'US Oregon'],
               ['US_Pennsylvania', 'US Pennsylvania'],
               ['US_Rhode_Island', 'US Rhode Island'],
               ['US_South_Carolina', 'US South Carolina'],
               ['US_South_Dakota', 'US South Dakota'],
               ['US_Tennessee', 'US Tennessee'],
               ['US_Texas', 'US Texas'],
               ['US_Utah', 'US Utah'],
               ['US_Vermont', 'US Vermont'],
               ['US_Virginia', 'US Virginia'],
               ['US_Washington', 'US Washington'],
               ['US_West_Virginia', 'US West Virginia'],
               ['US_Wisconsin', 'US Wisconsin'],
               ['US_Wyoming', 'US Wyoming'],
               ['Uruguay', 'Uruguay'],
