...
if [ $timescale = "monthly" ]; then
    ...
    vars1="cdd csdi cwd dtr fd gsl id prcptot"
			...
			do
				...
				for var in $vars; do
					case $var in
						...
						mr*) type=Lmon;;
						sic) type=OImon;;
	                     cdd|csdi|cwd|dtr|fd|gsl|id|prcptot|r1mm|r10mm|r20mm|r95p|r99p|rx1day|rx5day|sdii|su|tn10p|tn90p|tnn|tnx|tx10p|tx90p|txn|txx|wsdi) type=yr;;
						*) type=Amon;;
					esac
